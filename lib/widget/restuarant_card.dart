...
class Restaurant {
  ...
  Restaurant({required this.imageUrl, required this.name, required this.address, required this.rating, required this.reviewCount, required this.id});
}

List<Restaurant> restaurants = [
  Restaurant(
      id:1,
      imageUrl: 'https://images.unsplash.com/photo-1511018556340-d16986a1c194?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTh8fGJha2VyeXxlbnwwfHwwfHx8MA%3D%3D&auto=format&fit=crop&w=600&q=60',
  ...
  Restaurant(
      id: 2,
      imageUrl: 'https://images.unsplash.com/photo-1479044769763-c28e05b5baa5?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1470&q=80',
              ...
              ClipRRect(
                ...
                child: Padding(
                  ...
                  child: Container(
                    ...
                    child: Image.network(
                      restaurant.imageUrl,
                      fit: BoxFit.cover, // This makes the image scale down to fit within the box while maintaining its aspect ratio.
                    ),
                  ),
                ),
              ),
              Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    SizedBox(height: 4.0), // Add some space between the name and the address
                    Row(
                      children: <Widget>[
                        Icon(Icons.location_on, size: 20, color: Colors.grey,), // This is the location icon
